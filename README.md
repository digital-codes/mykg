...
**`knowledge_graph.ttl`** — pure RDFS triples, no edge metadata:
...
For a thorough description of the architecture, algorithm, data models, and design decisions, see [docs/design.md](docs/design.md).
