...
- **Incremental updates** — append new files to an existing session; schema is reused, only new files are extracted. A locked schema-growth mode can expand the vocabulary from changed files while preserving existing concepts and properties
